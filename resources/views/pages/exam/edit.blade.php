                                ...
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="user_id">
                                                        ...
                                                        @foreach ($user as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $exam->user_id ? 'selected' : ''}}>{{ $item->fullname }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="mapel_id">
                                                        ...
                                                        @foreach ($mapel as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $exam->mapel_id ? ' selected' : '' }}>{{ $item->mapel }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="class_room_id">
                                                        ...
                                                        @foreach ($class as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $exam->class_room_id ? ' selected' : '' }}>{{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="major_id">
                                                        ...
                                                        @foreach ($major as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $exam->major_id ? ' selected' : '' }}>{{ $item->major }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="input-group input-group-merge">
                                                    <input id="soal_1" style="text-align: left" value="{{$exam->soal_1}}" name="soal_1" class="form-control"
                                                        placeholder="Masukkan Kode Soal" type="text" autocomplete="off">
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="input-group input-group-merge">
                                                    <input id="soal_2" style="text-align: left" value="{{$exam->soal_2}}"  name="soal_2" class="form-control"
                                                        placeholder="Masukkan Kode Soal" type="text" autocomplete="off">
                                                    <div class="form-control-icon">
                                                        <i data-feather="server"></i>
                                                    </div>
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <select class="form-control" name="random_question">
                                                        <option value="not_random" {{"not_random"== $exam->random_question ? ' selected' : '' }}>Tidak</option>
                                                        <option value="random" {{"random"== $exam->random_question ? ' selected' : '' }}>ya</option>
                                                    </select>
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-8">
                                            <textarea type="text" class="form-control mt-2" id="description" name="description">{{$exam->description}}</textarea>
                                        </div>
    ...
    <script type="application/javascript">
        $(document).ready(function() {
            ...
            $('#form_exam').on('submit', function(e) {
                ...
                var url = "{{route('exam.update',$exam->id)}}";
                $('#mapel_id-error').text('');
