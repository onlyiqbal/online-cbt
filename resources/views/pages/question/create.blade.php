                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <textarea type="text" class="form-control mt-2"
                                                                        id="soal" name="data[1][question]"></textarea>
                                                                    ...
                                                                    <textarea type="text"
                                                                        class="form-control mt-2 pilihan" id=""
                                                                        name="data[1][choice_1]"></textarea>
                                                                    <label><b>Pilihan 2</b></label>
                                                                    <textarea type="text"
                                                                        class="form-control mt-2 pilihan" id=""
                                                                        name="data[1][choice_2]"></textarea>
                                                                    <label><b>Pilihan 3</b></label>
                                                                    <textarea type="text"
                                                                        class="form-control mt-2 pilihan" id=""
                                                                        name="data[1][choice_3]"></textarea>
                                                                    <label><b>Pilihan 4</b></label>
                                                                    <textarea type="text"
                                                                        class="form-control mt-2 pilihan" id=""
                                                                        name="data[1][choice_4]"></textarea>
                                                                    <label><b>Pilihan 5</b></label>
                                                                    <textarea type="text"
                                                                        class="form-control mt-2 pilihan" id=""
                                                                        name="data[1][choice_5]"></textarea>
