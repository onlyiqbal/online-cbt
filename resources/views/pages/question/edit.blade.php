                                ...
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="user_id">
                                                        @foreach ($user as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $question->user_id ? 'selected' : ''}}>{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group has-icon-left mt-2">
                                                <div class="position-relative">
                                                    <select class="form-control" id="type" name="type" disabled>
                                                        <option value="pilgan" {{"pilgan" == $question->type ? 'selected' : ''}}>Pilihan Ganda</option>
                                                        <option value="essay" {{"essay" == $question->type ? 'selected' : ''}}>Essay</option>
                                                    </select>
                                                    <div class="form-control-icon">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="mapel_id" disabled>
                                                        @foreach ($mapel as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $question->mapel_id ? 'selected' : ''}}>{{ $item->mapel }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="class_room_id" disabled>
                                                        @foreach ($class as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $question->class_room_id ? 'selected' : ''}}>{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                                ...
                                                <div class="position-relative">
                                                    <select class="form-control" name="major_id" disabled>
                                                        @foreach ($major as $item)
                                                            <option value="{{ $item->id }}" {{$item->id == $question->major_id ? 'selected' : ''}}>{{ $item->major }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-12 d-flex justify-content-end ">
                                            <a href="{{route('list-detail-question',$question->id)}}" class="btn btn-success me-1 mb-1"><i
                                                data-feather="save"></i>Update Detail Soal</a>
