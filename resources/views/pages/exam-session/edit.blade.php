...
@section('content')
    <div class="main-content container-fluid">
        <section class="section">
            <a href="{{ route('exam-session.index') }}" class="btn icon icon-left btn-primary"><i data-feather="arrow-left"></i>
               Kembali</a>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="name" value="{{$exam_session->name}}" class="form-control" placeholder="Ex Sesi 1"
                                                        id="first-name-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" name="time_start" class="form-control" placeholder="time start" value="{{$exam_session->time_start}}"
                                                        id="first-name-icon">
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <label>Ujian Di Berakhir</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" name="time_end" class="form-control" placeholder="time end"  value="{{$exam_session->time_end}}"
                                                        id="first-name-icon">
                                                </div>
