                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" name="name" value="{{$exam_session->name}}"
                                                    class="form-control" placeholder="Ex Sesi 1" id="first-name-icon">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="datetime" name="time_start" class="form-control"
                                                    placeholder="time start" value="{{$exam_session->time_start}}"
                                                    id="first-name-icon">
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="datetime" name="time_end" class="form-control"
                                                    placeholder="time end" value="{{$exam_session->time_end}}"
                                                    id="first-name-icon">
                                            </div>
