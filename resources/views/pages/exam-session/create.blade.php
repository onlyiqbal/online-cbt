                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="name" class="form-control" placeholder="Ex Sesi 1"
                                                        id="first-name-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" name="time_start" class="form-control" placeholder="time start"
                                                        id="first-name-icon">
                                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="time" name="time_end" class="form-control" placeholder="time end"
                                                        id="first-name-icon">
                                                </div>
