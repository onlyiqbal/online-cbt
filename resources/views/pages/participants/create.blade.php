...
@section('content')
    <div class="main-content container-fluid" style="margin-top: -30px !important">
        <section class="section">
            <a href="{{ route('participant.index') }}" class="btn icon icon-left btn-primary"><i data-feather="arrow-left"></i>
            Kembali</a>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input name="shcool_name" type="text" name="password" class="form-control"
