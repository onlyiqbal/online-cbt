                                            ...
                                            <div class="position-relative">
                                                <select name="class" class="form-control">
                                                    ...
                                                    <option value="{{ $item->id }}" {{ $item->id ==
                                                        $participant->class_room_id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="form-control-icon">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <select name="jenkel" class="form-control">
                                                    ...
                                                    <option value="male" {{ $participant->jen_kel == 'male' ? 'selected'
                                                        : '' }}>Laki
                                                        Laki</option>
                                                    <option value="female" {{ $participant->jen_kel == 'female' ?
                                                        'selected' : '' }}>
                                                        Perempuan</option>
                                                </select>
                                                <div class="form-control-icon">
